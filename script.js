    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Oncology and Immunotherapy Lab משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a7eab896-506f-4f06-ba07-61d44cbd8199',
                    name: data.name || '',
                    email: data.email || '',
